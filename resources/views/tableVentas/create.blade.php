...
@section('content')
      ...
      {{ Form::open(['route'=>'tableVentas.store', 'method'=>'POST']) }}
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<i><datalist name="cliente" id="cliente">
							...
							<option data-value="{{ $per->id }}">
								{{ $per->Nombre_Cliente }}
							</option>
							@endforeach
						</datalist></i> 
						<i>{{ Form::text('cliente',NULL, ['class'=>'form-control', 'id'=>'cliente', 'list'=>'cliente', 'placeholder'=>'Nombre del cliente...']) }}</i> 
					</div>
				</div><!-- fin col-md-3 -->
				<div class="col-md-3">
					<div class="form-group">
